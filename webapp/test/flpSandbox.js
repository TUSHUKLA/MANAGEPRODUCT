		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comtusharsmanageproduct-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtusharsmanageproduct-display": {
								"semanticObject": "comtusharsmanageproduct",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tushars.manageproduct",
									"url": sap.ui.require.toUrl("com/tushars/manageproduct")
								}
							}
						}
					}
